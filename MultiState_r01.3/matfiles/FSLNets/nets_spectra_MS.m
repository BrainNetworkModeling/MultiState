...
function [ts_spectra] = nets_spectra_MS(ts,varargin);   % produce subject-averaged spectra
...
FIG=figure('Position',[10 10 1600 900]);
...
for i=1:II
  subplot('position', [ gap*i+xw*(i-1) gap xw yh ]);
