...
function [Znet,Mnet]=nets_groupmean_MS(netmats,gofigure,des,varargin);
...
%  set(gca,'xTickLabel',NetFlags.Label);
  set(gca,'yTickLabel',NetFlags.Label,'YTick',[1:numel(NetFlags.Label)],'XTick',[1:2:numel(NetFlags.Label)]);
  ...
  title('scatter of each subject''s FC vs mean FC (of each nodes)');
