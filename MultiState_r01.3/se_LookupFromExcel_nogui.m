...
gname = '/data/Team_Eickhoff/Hoffstaedter/MultiState_RELEASE/MultiState_072015/Phenotypical/PD_Tremor.xlsx'

% gname = spm_select(Inf,'any','Select lookup speadsheets','',fullfile(pwd,'Phenotypical'),'.xls');
[A B] = xlsread(gname,1,'','basic');

who = 1; % spm_input('Include','!+1','b','All|RS/VBM|3Modal',[1 2 3],1,'Select mode');
wat = 2; % spm_input('With Cov ->','!+1','b','Complete|All',[1 2],1,'Select mode');
match = 0; % spm_input('Match groups','!+1','b','Movements/Age/Sex|Age/Sex|None',[1 2 0],1,'Select mode');
